...
tf.app.flags.DEFINE_integer("lr_decay_step", 10000, "learning rate decay step")
tf.app.flags.DEFINE_integer("lr_decay_rate", 0.95, "learning rate decay rate")
tf.app.flags.DEFINE_integer("iterations", 2000000, "number of iterations for training")
