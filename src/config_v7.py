...
tf.app.flags.DEFINE_string("writer_dir", "/mnt/juhee/logs/tensorboard", "tensorboard writer directory")
...
tf.app.flags.DEFINE_string("frame_or_feats", "feats", "whether using sampled frames or extracted features as input")
