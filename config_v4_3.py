...
# training config
tf.app.flags.DEFINE_integer("num_events", 24, "number of event(only one event can be processed")
...
tf.app.flags.DEFINE_integer("dim_feedforward", 6, "dimension of feedforward layer")
